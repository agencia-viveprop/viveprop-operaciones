...
**Rehecho el 2026-09-02** (`D-098`). Lo pedido cambió: *«mostrar cómo van moviéndose los canjes y los negocios semana a semana dentro del mes, y a la vez compararlo con meses anteriores»*. La ventana móvil de 1/2/4 semanas y sus cuatro casillas se retiraron --una ventana corrida no tiene con qué mes compararse-- y quedó el **flujo del mes** --entraron / avanzaron / se cayeron-- con el eje en las semanas del mes y los meses anteriores en barras al lado (`D-099`), más el embudo de entradas por etapa, la foto de lo abierto con su plata, y el bloque mes a mes con la tendencia. 24 tests.
