...
**La comisión de Dataprop es la de los canjes activos.** En el Centro de Control el bloque muestra **una** cifra de comisión --la de los canjes activos, **en cualquier etapa**-- porque es la única que es plata en juego, y cuadra con la casilla de «Activos» de la misma pantalla. Lo facturado al cerrar y lo que no se llegó a cobrar en los cancelados **no se borran: bajan a un renglón de referencia**, rotulados por lo que son. Iban en tres tarjetas iguales, y con 5 activos contra 224 cancelados la cifra más grande de la fila era la de los cancelados --$39,7 millones contra $1,7--, que no es comisión de nadie (`D-102`).
