...
**El reporte por período.** *Reporte mensual* tiene los dos dominios en un selector, el mes arriba a la derecha y una **ventana móvil de 1 a 12 meses** más la histórica. **El grano del desglose se deriva de la ventana**, no es un segundo control: con un mes las barras son las **semanas de ese mes** --contadas desde el día 1, cuatro o cinco según el mes-- y con dos o más, los meses. Un interruptor **superpone el período anterior o el mismo período del año pasado** como línea partida, con su propio rótulo en la leyenda; la distingue el trazo y no el color, porque el color que hacía falta no pasaba el validador de paleta contra el teal de la tendencia. Además de la plata de negocios, **canjes ya tiene la suya**: monto de ventas y de arriendos separados --nunca sumados-- y la comisión de Dataprop con la regla del contrato, con el contador de los que no se pueden valorizar por falta de UF a la vista. Y dos paneles por dominio: **en qué etapa o estado está lo que entró en la ventana**, y **cuánto llevan los abiertos en la etapa en que están**, con el `n` visible porque son promedios de uno o dos casos (`D-098`).
