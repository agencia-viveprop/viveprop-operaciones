...
**Se usa en teléfono y en tablet.** Bajo 768 px la barra lateral se colapsa y se abre con el botón de menú, que vive en una cabecera que **existe solo en pantalla chica**: desde 992 px la app se ve exactamente igual que antes. Las cifras se miden contra el ancho de su tarjeta --no de la ventana-- así que un monto no se corta a la mitad, y las casillas de plata esperan hasta 992 px para pasar a cuatro columnas, porque a 820 la barra lateral deja 528 px de contenido y cuatro columnas de plata no caben. Las tablas anchas y las filas de filtros se desplazan dentro de su caja, nunca empujando la página. Verificado en 11 rutas × 5 anchos de dispositivo, midiendo desborde y texto cortado (`D-093`).
